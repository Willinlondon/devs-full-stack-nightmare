describe('Character', () => {
  describe('when a new user is initialized the following should pass', () => {
    beforeEach(() => {
  ...
  describe('these should test when a character attacks', () => {
    beforeEach(() => {
  ...
  describe('when a user is attempting to move', () => {
    beforeEach(() => {
