class Config {
	...
	static precisionStrike = new Ability("Calculated Process", "Damaging", 5, 8, 0, 0);
	static wildFlail = new Ability("Stab in the Dark", "Damaging", 2, 13, 0, 0);
	static heal = new Ability("Refresh", "Heal", 0, 0, 4, 7);
