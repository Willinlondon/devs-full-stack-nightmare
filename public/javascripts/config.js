class Config {
	...
	//   "an angry, obnoxious"
	//   )
	static undefinedReality = new Ability(
		"Undefined Reality",
		"Damaging",
		5,
		8,
	...
	static failureBombardment = new Ability(
		"Failure Bombardment",
		"Damaging",
		6,
		12,
	...
	static confusionAndChaos = new Ability(
		"Confusion & Chaos",
		"Damaging",
		9,
		16,
	...
	//   "impatient, rude"
	// )
	static visualTermination = new Ability(
		"Visual Termination",
		"Damaging",
		5,
		8,
	...
	static countdownInitiated = new Ability(
		"Countdown Initiated",
		"Damaging",
		6,
		12,
	...
	static unforseenBlackout = new Ability(
		"Unforseen Blackout",
		"Damaging",
		6,
		12,
	...
	static conflictiveMerge = new Ability(
		"Conflictive Merge",
		"Damaging",
		5,
		8,
	...
	static invisibileBranch = new Ability(
		"Invisible Branch",
		"Damaging",
		5,
		8,
